package com.railway.transportation.starter.user.toolkit;
...
import static com.railway.transportation.framework.starter.bases.constant.UserConstant.*;
...
public final class JWTUtil {
    ...
    public static final String ISS = "railwayTransportation";
