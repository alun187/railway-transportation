package com.railway.transportation.framework.starter.web;
...
import com.railway.transportation.framework.starter.convention.exception.AbstractException;
...
public final class Results {
    ...
    public static Result<Void> failure() {
        return new Result<Void>().
                setCode(BaseErrorCode.SERVICE_ERROR.code()).setMessage(BaseErrorCode.SERVICE_ERROR.message());
    }
    ...
    protected static Result<Void> failure(AbstractException abstractException) {
        ...
        String errorMessage = Optional.ofNullable(abstractException.getErrorMessage()).orElse(BaseErrorCode.SERVICE_TIMEOUT_ERROR.message());
