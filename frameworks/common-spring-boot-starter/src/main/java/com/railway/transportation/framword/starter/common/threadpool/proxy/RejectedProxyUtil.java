...
import com.railway.transportation.framword.starter.common.toolkit.ThreadUtil;
...
public class RejectedProxyUtil {
     ...
     * @param rejectNum 拒绝策略执行统计器
     * @return 代理拒绝策略
     */
    public static RejectedExecutionHandler createProxy(RejectedExecutionHandler rejectedExecutionHandler, AtomicLong rejectNum) {
        ...
        return (RejectedExecutionHandler) Proxy.newProxyInstance(
                ...
                new RejectedProxyInvocationHandler(rejectedExecutionHandler, rejectNum)
        );
    }
